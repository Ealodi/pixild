...
//std::vector<Mylabel*>m_Piclabel;//上一次显示的插画label指针
...
void Pixiv::rank(QString mode,QString time){
    ...
    ui->scrollAreaWidgetContents_4->setMinimumHeight(ui->scrollArea_4->height() + 10);
...
void Pixiv::TagSearch(QString word)
{
    ...
    ui->scrollAreaWidgetContents_5->setMinimumHeight(ui->scrollArea_5->height() + 10);
